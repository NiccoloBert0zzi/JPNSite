...
export default function CulturaPage() {
    ...
    const city = cultura.find((c) => c.id === activeCity) || cultura[0];
            ...
            >
                ...
                <div className="relative container mx-auto max-w-5xl z-10 text-center">
                    ...
                    <p className="text-gray-200 text-xl font-light max-w-xl mx-auto">
                        Scopri la storia, le tradizioni e i segreti dei luoghi che visiterai.
                    </p>
                </div>
            </div>
                ...
                <div className="container mx-auto max-w-5xl px-6">
                    <div className="flex gap-1 overflow-x-auto py-3 scrollbar-hide">
                        {cultura.map((c) => (
                            <button
                                key={c.id}
                                onClick={() => { setActiveCity(c.id); setActiveSection(null); }}
                    ...
                    >
                        ...
                        <div className="relative rounded-2xl overflow-hidden shadow-xl mb-10 h-64 md:h-80">
                            <Image
                                ...
                                priority
                            />
                            <div className="absolute inset-0" style={{ background: `linear-gradient(to top, ${city.accent}cc 0%, transparent 60%)` }} />
                            <div className="absolute bottom-0 left-0 p-8">
                                <div className="flex items-baseline gap-3 mb-1">
                                    <h2 className="text-white text-4xl font-extrabold font-display drop-shadow-md">{city.name}</h2>
                                    <span className="text-white/70 text-2xl font-light">{city.kanji}</span>
                                </div>
                                <p className="text-white/90 text-lg font-light drop-shadow">{city.tagline}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-8">
                            {city.sections.map((s) => (
                                <button
                                    ...
                                    style={
                                        activeSection === s.id
                                            ? { backgroundColor: city.accent, color: 'white', borderColor: city.accent }
                            ...
                            {city.sections
                                ...
                                .map((section, i) => (
                                    <motion.div
                                        ...
                                        style={{ borderTop: `5px solid ${city.accent}` }}
                                    >
                                        <div className="p-6">
